    ...
    <div class="container mb-4"> 
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">Add User Details</div>
            ...
            <div class="card-body">
                <form method="post" action="<?php echo base_url("/crud/add_validation")?>" enctype="multipart/form-data" id="user_form">
					...
					<div class="form-group mb-3">
                        ...
                        {
                            echo "<div class='alert alert-danger mt-2'>".$validation->getError('dob')."</div>";
                        }
                        ?>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        {
                            echo '<div class="alert alert-danger mt-2">'.$validation->getError("gender").'
                            </div>';
                        }
                        ?>
					</div>
					...
					<div class="form-group mb-3">
                        ...
                        {
                            echo "<div class='alert alert-danger mt-2'>".$validation->getError('profile_pic')."</div>";
                        }
                        ?>
                    </div>
					<div class="form-group mb-3">
                        ...
                        {
                            echo "<div class='alert alert-danger mt-2'>".$validation->getError('address')."
                            </div>";
                        }
                        ?>
                    </div>
